...
public class ZipCodeEntityDeserializerTest extends AbstractJsonJUnit5Test {
	...
	public void setUp() throws JsonProcessingException {
		json = OBJECTMAPPER.writeValueAsString(createZipCode());
	}
	...
	public void test() throws JsonParseException, IOException {
		...
		ZipCodeEntityDeserializer deserializer = new ZipCodeEntityDeserializer();
		deserializer.setCodec(OBJECTMAPPER);
		System.out.println(json);
		
		ZipCodeEntity actualZip = deserializer.deserialize(parser, context);
		System.out.println(actualZip);
	}
}
